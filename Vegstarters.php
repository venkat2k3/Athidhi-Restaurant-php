...
<body>
    ...
    <button class="forw-right" onclick="window.location.href='Orders.php';" style='font-size:20px;'>&#8618;</button>
        ...
        <div class="box1">
            <img src="public\images\Panner tikka 1.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Paneer Tikka Masala 1.jpg" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box2">
            <img src="public\images\Paneer 65 1.jpg" alt="Biryani" />
            <div class="content2">
                <h3>Egg Biryani</h3>
        ...
        <div class="box1">
            <img src="public\images\gobi-manchurian.webp" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Chilli paneer 1.jpg" alt="Biryani" />
            <div class="content2">
