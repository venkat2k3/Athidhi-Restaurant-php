...
<body>
    ...
    <button class="forw-right" onclick="window.location.href='Orders.php';" style='font-size:20px;'>&#8618;</button>
        ...
        <div class="box1">
            <img src="public\images\Chicken 65 1.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Apollo fish fry 1.jpg" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box1">
            <img src="public\images\Chicken popcorn 1.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Chicken tikka 1.jpg" alt="Biryani" />
            <div class="content2">
                <h3>Egg Biryani</h3>
        ...
        <div class="box1">
            <img src="public\images\Tandoori chicken 1.jpg" alt="Biryani" />
            <div class="content1">
                <h3>Vegetable Biryani</h3>
                <p> Relish our Vegetable Biryani, where fresh, vibrant vegetables are cooked to perfection with aromatic, spiced basmati rice.</p>
                <button class="btn1" onclick="addToOrder('Vegetable Biryani', 109)">ADD</button>
            </div>
        </div><br/><br/>

        <div class="box2">
            <img src="public\images\prawn fry 1.jpg" alt="Biryani" />
            <div class="content2">
                <h3>Prawns Biryani</h3>
                <p>
                Treat yourself to our Prawns Biryani, where succulent, marinated prawns are cooked to perfection with fragrant, spiced basmati rice. </p>
                <button class="btn2" onclick="addToOrder('Prawn Biryani', 249)">ADD</button>
            </div>
        </div><br/><br/>

        <div class="box1">
            <img src="public\images\mutton fry 1.jpg" alt="Biryani" />
            <div class="content1">
                <h3>Fish Biryani</h3>
                <p>Enjoy our Fish Biryani, where tender, marinated fish fillets are perfectly cooked with aromatic, spiced basmati rice. </p>
                <button class="btn1" onclick="addToOrder('Fish Biryani', 239)">ADD</button>
            </div>
        </div><br/><br/>

        <div class="box1">
            <img src="public\images\Fish fry 1.jpg" alt="Biryani" />
            <div class="content1">
                <h3>Fish Biryani</h3>
                <p>Enjoy our Fish Biryani, where tender, marinated fish fillets are perfectly cooked with aromatic, spiced basmati rice. </p>
                <button class="btn1" onclick="addToOrder('Fish Biryani', 239)">ADD</button>
