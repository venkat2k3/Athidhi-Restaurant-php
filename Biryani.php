...
<body>
    ...
    <button class="forw-right" onclick="window.location.href='Orders.php';" style='font-size:20px;'>&#8618;</button>
        ...
        <div class="box1">
            <img src="public\images\chicken-biryani.jpeg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\mutton biryani.jpeg" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box1">
            <img src="public\images\Paneer biryani.jpeg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Egg biryani.jpeg" alt="Biryani" />
            <div class="content2">
                <h3>Egg Biryani</h3>
        ...
        <div class="box1">
            <img src="public\images\vegetable biryani.jpeg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Prawn biryani.jpeg" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box1">
            <img src="public\images\Fish biryani.jpeg" alt="Biryani" />
            <div class="content1">
                <h3>Fish Biryani</h3>
