...
<body>
    ...
    <button class="forw-right" onclick="window.location.href='Orders.php';" style='font-size:20px;'>&#8618;</button>
        ...
        <div class="box1">
            <img src="public\images\Panner butter masala 1.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Kadai Paneer 1.jpg" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box1">
            <img src="public\images\panner.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\paneer-curry.jpg" alt="Biryani" />
            <div class="content2">
                <h3>Egg Biryani</h3>
        ...
        <div class="box2">
            <img src="public\images\kaju paneer curry 1.jpg" alt="Biryani" />
            <div class="content2">
