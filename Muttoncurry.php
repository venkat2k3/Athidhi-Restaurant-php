...
<body>
    ...
    <button class="forw-right" onclick="window.location.href='Orders.php';" style='font-size:20px;'>&#8618;</button>
        ...
        <div class="box1">
            <img src="public\images\Mutton-curry1.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\mutton-curry.webp" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box1">
            <img src="public\images\Mutton paya 1.jpg" alt="Biryani" />
            <div class="content1">
