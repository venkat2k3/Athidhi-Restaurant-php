...
<body>
    ...
    <button class="forw-right" onclick="window.location.href='Orders.php';" style='font-size:20px;'>&#8618;</button>
        ...
        <div class="box1">
            <img src="public\images\chicken curry 1.jpg" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\chicken-curry.jpg" alt="Biryani" />
            <div class="content2">
        ...
        <div class="box1">
            <img src="public\images\chicken-curry.webp" alt="Biryani" />
            <div class="content1">
        ...
        <div class="box2">
            <img src="public\images\Kadai chicken 1.jpg" alt="Biryani" />
            <div class="content2">
                <h3>Egg Biryani</h3>
